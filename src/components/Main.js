...
const Main = () => {
	...
	if (typeof provider === undefined) setMetamask(false);
	...
	}, [account, balance, msg, refundEther, metamask]);
				...
				<div className="p-4">
					<div className="jumbotron text-center">
						...
						<h4 className="display-4">
							Please install Metamask Chrome Extension to use this aplication
						</h4>
						<a
							target="_blank"
